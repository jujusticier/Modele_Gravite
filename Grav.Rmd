...
```{r, tidy=TRUE}
#Créer une une variable couple de pays/annees dans les deux bases (CPA)
...
### il faut utiliser stringr ici pour supprimer annee
####peut etre inutile #### Table_Chelem$ij <- substr(Table_Chelem$CPA, 1, 7)
