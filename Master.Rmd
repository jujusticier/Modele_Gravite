...
- TROUVER pourquoi certains pays disparaissent en 2006
...
Table_Chelem <- filter(select(Donnees_Commerce, 5,7,8), k == "TT")
...
Table_Gravite <- merge(x=Table_Gravite,y=Table_Chelem, by= c("CPA") ,all= FALSE)
```
